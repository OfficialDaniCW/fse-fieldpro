...
import { MessageSquare, Search, BookOpen, User, Star, Shield, BarChart2 } from "lucide-react";
...
export default function Layout({ children, currentPageName }) {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      {/* Connection status bar — fixed, below the red page header */}
      {(isOffline || showOnlineBanner) && (
        <div className={`fixed top-[92px] left-0 right-0 z-[150] flex items-center justify-center gap-1.5 px-3 py-1 text-xs font-semibold shadow-sm ${
          isOffline
